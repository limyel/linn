...
import com.linn.common.core.utils.json.LocalDateTimeModule;
import com.linn.common.core.utils.local.DateFormatUtils;
...
public class JacksonAutoConfig {
    ...
    public ObjectMapper objectMapper(Jackson2ObjectMapperBuilder builder) {
        builder.simpleDateFormat(DateFormatUtils.DEFAULT_DATE_FORMAT);
