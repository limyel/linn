package com.linn.common.core.utils.local;
...
public abstract class DateFormatUtils {
    ...
    public static final DateTimeFormatter DEFAULT_DATETIME_FORMATTER = DateTimeFormatter.ofPattern(DEFAULT_DATETIME_FORMAT)
            .withZone(ZoneId.systemDefault());
    public static final DateTimeFormatter YMDHM_FORMATTER = DateTimeFormatter.ofPattern(YMDHM_FORMAT)
            .withZone(ZoneId.systemDefault());
    ...
    public static String formatTime() {
        return ZonedDateTime.now().format(DEFAULT_TIME_FORMATTER);
    }

    public static String formatTime(Date time) {
        return ZonedDateTime.ofInstant(time.toInstant(), ZoneId.systemDefault()).format(DEFAULT_TIME_FORMATTER);
    }

    public static String formatDatetime() {
        return ZonedDateTime.now().format(DEFAULT_DATETIME_FORMATTER);
    }

    public static String formatDatetime(Date date) {
        return ZonedDateTime.ofInstant(date.toInstant(), ZoneId.systemDefault()).format(DEFAULT_DATETIME_FORMATTER);
    }
    ...
    public static Date parseDatetime(String datetime) {
        return Date.from(ZonedDateTime.from(DEFAULT_DATETIME_FORMATTER.parse(datetime)).toInstant());
    }
